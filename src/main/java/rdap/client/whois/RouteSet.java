...
/**
 * https://www.apnic.net/manage-ip/using-whois/guide/route-set/
 * <p>
 * Defines a set of routes that can be represented by route objects or address prefixes.
 *
 * @author dzh
 * @date 2019-03-06 20:09
 */
public class RouteSet {

    private String routeSet;            //  [mandatory]  [single]     [primary/lookup key]
    ...
    public void setRouteSet(String routeSet) {
